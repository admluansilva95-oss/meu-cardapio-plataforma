...
const RESTAURANTE_COLUNAS =
  "id, nome, slug, whatsapp, logo, cor_tema, horario_funcionamento, taxa_entrega, vitrine_fechada, mensagem_fechado, funcionamento_semana, taxas_entrega_zonas, entrega_modo, retirada_balcao, cardapio_categorias" as const;
